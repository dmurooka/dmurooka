...
- **Mathematics**: Statistics, Linear Algebra, Discrete Mathmatics, Complex Analysis, Optimization Theory, Vector Calculus, Numerical Analysis, Real Analysis, Differential Equations
